    ...
    if request.POST["user"]:
        ...
        for usuario in usuarios:
             ...
             if usuario.contraseña == contraseña:
                 ...
                 logosnt = Organizaciones.objects.values_list('logo')
                 logos = []
                 print("aaaaaaaaaaaaaa",logosnt)
                 for i in logosnt:
                     print(i)
                     logos.append(str(i[0]))
                     print(logos)
                 ...
                 return render(request, "Inicio.html", {"query": email, "mensaje": mensaje,
                    "contraseña":contraseña, "institucion":institucion, "nombre":nombre ,"ap_pat":ap_pat, "ap_mat":ap_mat , "foto" : perfil,"logos": logos, "org": org, "rol": rol, "miembros": miembros})
...
def Fundaciones(request):
    #organizacion = request.GET["ctm"]
    print("aaaaaaaaaaaaaaaaaaaaaaaa, Organizaciones")
